...
`2026.7.19.106` 是当前标准安装器基线。新电脑只分发 `Hourlyreport_automation_setup_v2026.7.19.106.exe`，用户选择目录后一次安装完成。
...
8. GitHub Release tag 使用 `v2026.7.19.106`，在线更新资产名为 `Hourlyreport_automation_v2026.7.19.106.zip`；完整安装器名为 `Hourlyreport_automation_setup_v2026.7.19.106.exe`，两者用途不同。
